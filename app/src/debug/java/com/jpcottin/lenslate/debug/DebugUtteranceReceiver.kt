package com.jpcottin.lenslate.debug
 ...
 * ```
 * adb shell "am broadcast -a com.jpcottin.lenslate.debug.UTTERANCE \
 ...
 * adb shell "am broadcast -a com.jpcottin.lenslate.debug.READ_IMAGE \
...
class DebugUtteranceReceiver : BroadcastReceiver() {
    ...
    companion object {
        const val ACTION_UTTERANCE = "com.jpcottin.lenslate.debug.UTTERANCE"
        const val ACTION_READ_IMAGE = "com.jpcottin.lenslate.debug.READ_IMAGE"
